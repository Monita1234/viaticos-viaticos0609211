...
public class CtrlProgramacion{
    ...
    //reportegeneraldecajamenor
    public void registrarreporCaja_menor(Caja_menor pnl){
        SimpleDateFormat sdfDB = new SimpleDateFormat("yyyy-MM-dd");
        String  Fecha = sdfDB.format(pnl.fechaInicial.getDate());
        String  txtDetalle = pnl.txtDetalle.getText();
        String  txtValorcuenta = pnl.txtValorcuenta.getText();
        String  txtValorTotal = pnl.txtValorTotal.getText();
                
           
        Registrogeneral registrogeneral = new Registrogeneral();
        registrogeneral.setFecha(Fecha);
        registrogeneral.setDetalle(txtDetalle);
        registrogeneral.setValorcuenta(txtValorcuenta);
        registrogeneral.setValorTotal(txtValorTotal);
        
           modelo.registrogeneralCaja_menor(registrogeneral);
